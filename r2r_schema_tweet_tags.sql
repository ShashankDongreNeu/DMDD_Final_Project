...
CREATE TABLE `tweet_tags` (
  ...
  CONSTRAINT `Tweets_tweet_id_fk1` FOREIGN KEY (`tweet_id`) REFERENCES `Tweets` (`tweet_id`)
...
INSERT INTO `tweet_tags` VALUES ('1591142488882151424','mapleridge, homes, houseforsale, bcrealestate, ForSale'),('1591199536877535232','houseforsale, Oceanview, nearbeach');
